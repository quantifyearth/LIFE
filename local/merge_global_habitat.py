...
from yirgacheffe.layers import RasterLayer, RescaledRasterLayer, GroupLayer
...
def merge_global_habitat(
	global_layer_path: str,
	local_layer_path: str,
	...
	with RasterLayer.layer_from_file(local_layer_path) as local_layer:
		with RescaledRasterLayer.layer_from_file(global_layer_path, pixel_scale=local_layer.pixel_scale) as global_layer:
			...
			with RasterLayer.empty_raster_layer_like(combined, filename=output_layer_path, datatype=local_layer.datatype) as result:
