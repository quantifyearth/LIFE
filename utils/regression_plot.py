...
def regression_plot(
    ...
    with (
        ...
        if a_layer.projection != b_layer.projection:
        ...
        if a_layer.dimensions != b_layer.dimensions:
            sys.exit("GeoTIFFs have different pixel dimensions")

        a_pixels = a_layer.read_array(0, 0, a_layer.dimensions[0], a_layer.dimensions[1])
        b_pixels = b_layer.read_array(0, 0, b_layer.dimensions[0], b_layer.dimensions[1])
